    ...
    def __init__(self,
        ...
        Args:
            mode: str, "simbert-base" 使用simbert-base-chinese模型获得句向量
                       "google-128" 使用google-bert-uncase模型获得句向量
                       "text-sim" 使用text-sim模型获得句向量
            ...
            model_name_or_path: str, 句向量生成模型名称或存储路径, 模型名称与mode的对应关系为
                                     ...
                                     mode="google-128", model_name_or_path="google-bert-uncase"
        ...
        assert mode in ["simbert-base","google-128","text-sim", "roformer-sim-base", "roformer-sim-small", "paraphrase-multilingual-minilm"]
        self.mode = mode
    ...
    def encode(self,
        ...
        with torch.no_grad():
            for i in range(num_batches):
                ...
                if self.mode in ["simbert-base","google-128","text-sim", "roformer-sim-base", "roformer-sim-small"]:
